    ...
    describe "creating arrival and departure URLs" do
      context "given proper parameters" do
        ...
        it "creates a correct request URL with params" do
          url = server.build_arrival_and_departure_url(stop_id: stop_id, stop_sequence: stop_sequence, service_date: service_date, trip_id: trip_id, vehicle_id: vehicle_id)
